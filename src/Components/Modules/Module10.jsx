...
import Module10Ppt from "./Module10Ppt";
              ...
              */}
              {!showComponent2 && (
                <CardContent>
                  ...
                  >
                    At the end of this module, you will have an overview of:
                  </Typography>
                  ...
                  >
                    ...
                    */}
                    <ListItem style={{}}>Portfolio overview</ListItem>
                    <ListItem>Decision tools​</ListItem>
                    <ListItem>New to bank acquisition​</ListItem>
                    <ListItem style={{ marginLeft: "1rem" }}>
                      Incorporate Risk appetite and RDF​
                    </ListItem>
                    <ListItem>
                      Existing to Bank – Portfolio Management​​
                    </ListItem>
                    <ListItem style={{ marginLeft: "1rem" }}>
                      Incorporate Risk appetite and RDF​
                    </ListItem>
                    <ListItem>Portfolio Monitoring and Tracking​t​​</ListItem>
                  </List>
                </CardContent>
              )}
              {showComponent2 && (
