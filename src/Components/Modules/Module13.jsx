...
import Module13Ppt from "./Module13Ppt";
              ...
              {!showComponent2 && (
                <CardContent>
                  ...
                  >
                    ...
                    */}
                    <ListItem style={{}}>
                      Understand the key characteristics of the lower end of
                      Commercial Banking (CB) clients.​​
                    </ListItem>
                    <ListItem>
                      Recognize the key trends in the Middle Market (MM), Medium
                      Enterprise (ME), and High Value Small Business (HvSB)
                      portfolios.​
                    </ListItem>
                    <ListItem>
                      Identify the challenges in lending to clients in MM, ME,
                      and HvSB sub segments​
                    </ListItem>
                  </List>
                </CardContent>
              )}
