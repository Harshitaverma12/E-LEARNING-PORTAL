...
import Module1H from "../ModulesHtml/Module1H";
import CourseInfoHtml from "../ModulesHtml/CourseInfoHtml";

export default function SidebarHtmlDashboard() {
